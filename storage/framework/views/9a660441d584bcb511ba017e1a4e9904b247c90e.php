        ...
        <div id="<?= $article->a_id ?>" class="col mb-4">
            <div class="card h-100 vignette">
                <div class="position-relative p-1">
                    <button type="button" class="btn-close" aria-label="Close" onclick="js:confirmDeleteArticle(<?php echo e($article->a_id); ?>);"><span >&times;</span></button>
                </div>
                ...
                <div class="card-body">
                    ...
                    <span class="card-prix "><?php echo number_format($article->a_prix,2,',',' ') . ' &euro;'; ?></span>
                </div>
            </div>
        </div>
        <?php
...
<script type="text/javascript">
    ...
    function deleteArticle(id) {
        $.ajax({
            ...
            data: {"id": id, "_token": "<?php echo e(csrf_token()); ?>"},//données envoyées
